# -*- coding: utf-8 -*-
"""
Created on Sun Oct 22 02:30:18 2017
...
class SelectorBIC(ModelSelector):
    ...
    def select(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
            ...
            #an array to store the values of BIC
        bic_scores = []
...
class SelectorCV(ModelSelector):
    ...
    def select(self):
        ...
        try:
            for n_component in self.n_components:
                model = self.base_model(n_component)
                # Folding and calculating mean scores of the model
                fold_scores = []
                ...
                # Computing mean of all fold scores
